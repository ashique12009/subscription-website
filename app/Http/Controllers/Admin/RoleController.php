...
class RoleController extends Controller
{
    ...
    {
        $allPermissions = Permission::get()->pluck('name', 'name');
        $thisRolePermissions = [];
        return view('admin.role.create', compact('allPermissions', 'thisRolePermissions'));
    }
    ...
    public function edit($id)
    {
        $role = Role::findOrFail($id);
        $allPermissions = Permission::get()->pluck('name', 'name');
        $thisRolePermissions = DB::table('roles')
            ...
            ->where('roles.id', '=', $id)
            ->get();
        return view('admin.role.edit', compact('role', 'allPermissions', 'thisRolePermissions'));
    }
